...
function on_scroll(e)
{
    ...
    if ( scrollY >= 1 )
    {
        $('.main .header_mc').removeClass('on');
    }
    else
    {
        $('.main .header_mc').addClass('on');
...
function popupInit()
{
    ...
    $('.gnb_mc .btn_youtube').on('click', function(event)
    {
        ...
        $('.popup_mc .inner_sp .player iframe').attr('src' , 'https://www.youtube.com/embed/Ww0wYbNDmws?rel=0&vq=hd720&controls=1&showinfo=1&autoplay=1&loop=1&wmode=transparent&playlist=Ww0wYbNDmws');
    });
...
function showPOP(div)
{
    ...
    if (cookiedata.indexOf(div+"=done") < 0 )
    {
        ...
        $('#'+div).find('.inner_sp .player iframe').attr('src' , 'https://www.youtube.com/embed/Ww0wYbNDmws?rel=0&vq=hd720&controls=1&showinfo=1&autoplay=1&loop=1&wmode=transparent&playlist=Ww0wYbNDmws');
        $('#'+div).addClass('on');
    }
    else
    {
