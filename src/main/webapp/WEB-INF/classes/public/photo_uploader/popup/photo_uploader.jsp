...
<div id="pop_wrap">
    ...
    <div id="pop_container" class="pop_container" style="display:none;">
		...
		<div id="pop_footer">
	    <div class="btn_area">
            <a href="javascript:fn_imageUp5();"><img src="./public/img/photoQuickPopup/btn_confirm.png" width="49" height="28" alt="확인" id="btn_confirm"></a>
...
<script type="text/javascript" src="../public/photo_uploder/popup/jindo.min.js" charset="utf-8"></script>
<script type="text/javascript" src="../public/photo_uploder/popup/jindo.fileuploader.js" charset="utf-8"></script>
<script type="text/javascript" src="../public/photo_uploder/popup/attach_photo.js" charset="utf-8"></script>
