            ...
            <div class="main-content">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="content">
							...
							<c:forEach items="${page.content}" var="bo" varStatus="status">
								<tr>
									<td>
										<a href="<c:url value="/admin/news/update?num=${bo.itemNumber}#${bo.version}" />">
										${bo.itemNumber}
										</a>
									</td>
									<td>
									...
									<td>
										<a class="black" href="<c:url value="/admin/news/update?num=${bo.itemNumber}#${bo.version}" />">
										${bo.subject}
                    ...
                    <div class="pull-right">
                        <a type="button" href="<c:url value="/admin/news/write#" />" class="btn btn-primary btn-fill btn-wd">WRITE</a>
                    </div>
