...
<link href="../public/css/ko_KR/smart_editor2.css" rel="stylesheet" type="text/css">
<style type="text/css">
	body { margin: 10px; }
</style>
<script type="text/javascript" src="../public/js/lib/jindo2.all.js" charset="utf-8"></script>
<script type="text/javascript" src="../public/js/lib/jindo_component.js" charset="utf-8"></script>
<script type="text/javascript" src="../public/js/service/SE2M_Configuration.js" charset="utf-8"></script>	<!-- 설정 파일 -->
<script type="text/javascript" src="../public/js/service/SE2BasicCreator.js" charset="utf-8"></script>
<script type="text/javascript" src="../public/js/smarteditor2.js" charset="utf-8"></script>
<!-- <script type="text/javascript" src="../public/photo_uploader/plugin/hp_SE2M_AttachQuickPhoto.js" charset="utf-8"></script> -->
...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	makePopupURL : function(){
		var sPopupUrl = "../photo_uploader/popup?id=${param.id}";
...
function pasteHTML(filepath){ 
	...
	g_editor.oApp.exec("PASTE_HTML", ["<img src='"+ filepath +"''>"]); // 위즐 첨부 파일 부분 확인
}
