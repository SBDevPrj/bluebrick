...
<div class="wrap">
    ...
    <div class="inner_mc sub_top_mc">
        <div class="content_mc">
            <h2 class="title fn--p">Privacy Policy</h2>
        </div>
    </div>
    ...
    <div class="inner_mc privacy_mc ">
        <div class="content_mc">
            ...
            <div class="text_box">
                            ...
                            <li>
                                ...
                                <div class="ud">
                                    ...
                                    <ul class="ust ty4 mgl-50">
                                        <li>Duration and records of use of services, log-in access, content used, cookies, and IP access information</li>
                                    </ul>
                                </div>
                                <br><br>
                            </li>
                ...
                <ul class="ust ty2 mgl-40">
                    <li>Duration of use: During the period of service use or with a dispute.</li>
                </ul>
                <br>
                <p class="mgl-40 f_18">However, the following information will be preserved over the specified period for the following reasons:</p>
                <br>

                <ul class="ust ty2 mgl-75">
                    <li>
                        <div class="uh">A. </div>
                        <div class="ud">
                            ...
                            <ul class="ust ty4 mgl-50">
                                <li>
                                    <dl>
                                        <dt>Records on processing dissatisfaction complaints or disputes with consumers.</dt>
                                        <dd>- Reason for preservation: Law on the protection of consumers in e-commerce, etc.</dd>
                                        <dd>- Preservation period: 3 years</dd>
                                    </dl>
                                    <br>
                                ...
                                <li>
                                    <dl>
                                        <dt>Records for identification of individuals</dt>
                                        <dd>- Reason for preservation: Law on promotion of use and protection of information in information communication networks.</dd>
                                        <dd>- Preservation period: 6 months</dd>
                                    </dl>
                                    <br>
                                </li>
                                <li>
                ...
                <table>
                    <tr>
                        <th style="width: 270px;">Doa Co., Ltd.</th>
                        <td style="width: 900px">Information necessary for advertisement, marketing, events, and shipping of giveaways</td>
                    </tr>
                    <tr>
                        <th style="width: 270px;">Korea Corporation Co., Ltd.</th>
                        <td style="width: 900px">Customer center duties including customer consultations and management, and CRM, etc.</td>
                    </tr>
                </table>
                <br><br><br>
                <h3 class="ht1">Chapter 8. <span class="slash"></span> Installation and operation of automatic collection device for <span style="margin-left: 200px;">personal information, and issues on the refusal thereof</span></h3>

                <ul class="ust ty3 mgl-70">
                    <li>
                ...
                <ul class="ust ty1 mgl-70">
                    ...
                    <li>
                        ...
                        <br>
                        <ul class="ust ty4 mgl-50">
                            <li>Personal Information Infringement Report Center : privacy.kisa.or.kr / (without area code) 118</li>
                            <li>Information Protection Mark Certification Committee : eprivacy.or.kr / 02-550-9531~2</li>
                            <li>Cyber Investigation Division of the Supreme Prosecutor’s Office : www.spo.go.kr / (without area code) 1301</li>
                            <li>Cyber Safety Bureau of the Korean National Police Agency : cyberbureau.police.go.kr / (without area code) 182</li>
                        </ul>
