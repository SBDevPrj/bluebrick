        ...
        <div class="content_mc">
            ...
            <div class="text_box">
                ...
                <ul class="ust ty1 mgl-70">
                    ...
                    <li>회사는 개인정보처리방침을 개정하는 경우 웹사이트(https://www.bluebrick.io) 공지사항 또는 개별공지)를 통하여 공지합니다.</li>
                </ul>
                ...
                <ul class="ust ty1 mgl-70">
                    ...
                    <li>기타 개인정보처리방침(https://www.bluebrick.io)에 고지된 수탁자에게 서비스 제공 등 계약의 이행에 필요한 업무의 위탁</li>
                </ul>
                            ...
                            <li>
                                ...
                                <div class="ud">
                                    ...
                                    <ul class="ust ty4 mgl-50">
                                        <li>서비스 이용시간/이용기록, 접속로그, 이용 콘텐츠, 쿠키, 접속 IP 정보</li>
                                    </ul>
                                </div>
                                <br><br>
                            </li>
                ...
                <div class="ht2">이용자의 개인정보는 원칙적으로 개인정보의 수집 및 이용목적이 달성되면 지체 없이 파기 합니다.</div>
                <br>

                <ul class="ust ty2 mgl-40">
                    <li>이용기간 : 서비스 이용기간 또는 분쟁기간 동안</li>
                </ul>
                <br>
                <p class="mgl-40 f_18">단, 다음의 정보에 대해서는 아래의 이유로 명시한 기간 동안 보존 합니다.</p>
                <br>
                ...
                <p class="mgl-40 f_18">단, '법률에 특별한 규정이 있는 경우'로 행정목적이나 수사목적으로 행정관청 또는 수사기관이 요구해 온 경우라도 무조건 고객의 개인정보를 제공하지 않으며, 법률에 규정된 바에 따라 영장 또는 기관장의 직인이 날인된 서면에 의한 경우 등 적법한 절차에 따라 제공합니다.<br><br>
                회사는 고객에 대하여 보다 나은 서비스 제공 등을 위해 아래와 같이 개인정보를 제공하고 있습니다.</p>
                <br><br><br>
                ...
                <ul class="ust ty3 mgl-70">
                    <li>
                        <div>쿠키란 회사에서 제공하는 서비스를 통하여 고객님의 정보를 저장하고 수시로 찾아내는 쿠키 서버의 부가적인 요청이 있을 때 다시 서버로 보내주는 문자열 정보를 말합니다. 고객님께서 웹사이트에 접속을 하시면 고객님의 브라우저에 있는 쿠키의 내용을 읽고, 추가정보를 찾아 접속에 따른 성명 등의 추가 입력 없이 서비스를 제공할 수 있습니다.</div>
                    </li>
                    <li>
                    ...
                    <li>
                        <div>고객님은 쿠키 설치에 대한 선택권을 가지고 있습니다. 따라서, 웹브라우저에서 옵션을 설정함으로써 모든 쿠키를 허용하거나, 쿠키가 저장될 때마다 확인을 거치거나, 아니면 모든 쿠키의 저장을 거부할 수도 있습니다. 단, 고객님께서는 쿠키 설치를 거부하였을 경우 서비스 이용에 불편이 있거나, 서비스 제공에 어려움이 있을 수 있습니다.</div>
                    </li>
                    <li>
                ...
                <div class="ht2">
                    회사는 고객의 개인정보보호를 매우 중요시하며, 고객의 개인정보가 훼손. 침해 또는 누설되지 않도록 최선을 다하고 있습니다. <br>
                    회사는 고객의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련부서 및 개인정보 보호책임자를 지정하고 있습니다.<br><br>

                    귀하께서는 회사의 서비스를 이용하시며 발생하는 모든 개인정보보호 관련 민원을 개인정보보호 담당부서 혹은 개인정보보호책임자에게 신고하실 수 있습니다.<br>
                ...
                <ul class="ust ty1 mgl-70">
                    ...
                    <li>
                        ...
                        <ul class="ust ty4 mgl-50">
                            ...
                            <li>정보보호마크인증위원회 : eprivacy.or.kr / 02-550-9531~2</li>
