...
<div class="wrap">
    ...
    <div class="inner_mc technical_mc">
        ...
        <section class="technic_sec1" style="padding-bottom: -150px;">
            <div class="content_mc">
                <h2>Technique <span>기술정보</span></h2>
                <!--
                <div class="tech_title">
                    <span class="ic-sets ty6-1"></span><h3>BlueBrick <span>핵심 컨셉</span></h3>
                </div>
                -->
                <div class="sub_title">
                    <span class="ic-sets ty6-3 aft">01</span><h4>블루브릭 플랫폼 아키텍처</h4>
                </div>
                <p>블루브릭을 통해 한 쉽고 편리한 블록체인 네트워크 구축과 관리가 가능합니다. 이를 기반으로 공공, 금융, 유통, 문서관리, 문서 원본 증명 등 다양한 비즈니스 파일럿 프로젝트 검증이 용이합니다.
                    </p>
                <img src="<c:url value="/public/imgs/technical/tech_img1_kr.jpg"/>" alt="">
            </div>
        </section>
        <section class="technic_sec2">
            <div class="content_mc">
                <div class="sub_title">
                    <span class="ic-sets ty6-3 aft">02</span><h4>무한 확장 가능한 BaaS형(Blockchain as a Service) 프라이빗 블록체인 메인넷</h4>
                </div>
                <p>이더리움 기반의 프라이빗 메인넷 블루브릭은 기존 금융 비즈니스 영역과 금융 영역을 융합할 수 있고, 트랜젝션 처리에 있어 속도 등의 기술적 한계를 극복할 수 있는 무한 확장 가능한 멀티사이드 체인을 활용합니다.
                </p>
                <img src="<c:url value="/public/imgs/technical/tech_img2_kr.jpg"/>" alt="">

                <!-- -->
                <div class="sub_title" style="margin-top: 50px;">
                    <span class="ic-sets ty6-5 aft"></span><h4 style="margin-left: 60px; margin-top:15px;">하나의 블록체인에서 모든 서비스를 처리할 필요는 없습니다.</h4>
                </div>
                ...
                <img src="<c:url value="/public/imgs/technical/tech_img3_kr.jpg"/>" alt="">
            </div>
        </section>
        <section class="technic_sec1">
            <div class="content_mc">
                <div class="sub_title">
                    <span class="ic-sets ty6-3 aft">03</span><h4>하이퍼레저 패브릭 기반의 기업 맞춤형 솔루션 제공</h4>
                </div>
                <p>블록체인 도입에 어려움을 겪고 있는 기업에게 맞춤형 설치 및 활용 가능한 서비스를 제공해, 단기간 내 합리적인 비용으로 누구나 쉽게 기존 비즈니스에 블록체인 기술 적용이 가능합니다.
                    <br><br>
                    </p>
                <img src="<c:url value="/public/imgs/technical/tech_img4_kr.jpg"/>" alt="">
                <br><br>
            </div>
        </section>
        <section class="technic_sec3">
            <div class="content_mc">
                <div class="sub_title">
                    <span class="ic-sets ty6-3 aft">04</span><h4>중견 기간 통신사가 보장하는 네트워크 안정성, 보안, 신뢰</h4>
                </div>
